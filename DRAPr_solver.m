...
% 1. Generates random instances of the Distributionally-robust assignment
% problem (DRAP)
% 2. Solves the deterministic and randomized strategy DRAP by calling the function DRAPr
% 3. Tests the solutions obrained on out-of-sample data
% 4. Writes the results to an Excel file

%% Generate random DRAP instances
...
%% Solve the DRAP with and without randomization
...
Result = [ins, vd, cpud, vr, length(pr),cpur,OSd,OSr]; % Results, to be stored on the excel file
